...
(function (window, document, exports, global, define, undefined) {
    ...
    window.html2canvas = function (nodeList, options) {
        ...
        //    return canvas;
        //});
        //todo 这里修改开放出宽度和高度解决超出浏览器可视区域时截屏的问题
        var width = options.containerWidth || node.ownerDocument.defaultView.innerWidth;
        var height = options.containerHeight || node.ownerDocument.defaultView.innerHeight;
